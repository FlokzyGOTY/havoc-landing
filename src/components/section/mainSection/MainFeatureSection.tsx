            ...
            <div className="sect-main flat-animate-tab">
                ...
                <div className="container">
                    <div className="sect-title wow fadeInUp">
                        <h2 className="s-title font-3">What You Can Do with Havoc</h2>
                        <p className="s-sub_title">
                            From visuals to code, Havoc gives you a full creative suite powered by <br className="d-none d-lg-block" />
