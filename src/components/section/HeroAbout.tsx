                    ...
                    <div className="row">
                        <div className="col-lg-10 mx-auto">
                            <div className="sect-title wow fadeInUp">
                                ...
                                <p className="s-sub_title">
                                    From visuals to code, Havoc gives you a full creative suite powered by <br className="d-none d-md-block" />
                        ...
                        <div className="col-lg-4 offset-lg-1">
                            <div className="px-16 px-lg-0">
                                <p className="text-caption caption font-2 text-main-2">ABOUT HAVOC</p>
