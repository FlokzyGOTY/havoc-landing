...
export const metadata: Metadata = {
    title: "Havoc - Next Js AI Template",
    description: "Havoc is an AI-powered Next.js template generated by Themesflat, optimized for high performance and modern design.",
    keywords: ["Havoc", "Next.js", "AI Template", "Themesflat", "React", "Website Template"],
    robots: "index, follow",
