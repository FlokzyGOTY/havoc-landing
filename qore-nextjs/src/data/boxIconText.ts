...
export const boxIconTextProps: BoxIconTextProp[] = [
    {
        ...
        sub_title: "No more juggling tools. Havoc unifies content, design, code, and video.",
    },
    {
        image_icon: "ai-core.svg",
        title: "Multi-model AI core",
        sub_title: "ChatGPT, Claude, Gemini — Havoc picks the smartest engine for every task.",
    },
    {
    ...
    },
    {
        ...
        sub_title: "From solo to teams, Havoc delivers fast outputs — even under heavy loads.",
    },
    {
    ...
    },
    {
        ...
        sub_title: "Havoc improves weekly with better prompts, UI, and models — for free.",
    },
];
